...
-- CreateIndex
CREATE UNIQUE INDEX "Home_address_key" ON "Home"("address");
...
-- AddForeignKey
ALTER TABLE "Image" ADD CONSTRAINT "Image_home_id_fkey" FOREIGN KEY ("home_id") REFERENCES "Home"("id") ON DELETE SET NULL ON UPDATE CASCADE;
